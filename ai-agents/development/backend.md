...
- **Public APIs Catalog**: Use `public-apis-reference` skill to discover 1500+ free APIs across 51 categories. Before building a custom integration, always check if a free public API exists.
