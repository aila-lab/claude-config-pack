...
```bash
node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs validate health $REPAIR_FLAG
```
...
```bash
node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs validate health
```
