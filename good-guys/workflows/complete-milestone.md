...
```bash
ROADMAP=$(node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs roadmap analyze)
```
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs summary-extract "$summary" --fields one_liner | jq -r '.one_liner'
done
```
...
```bash
ARCHIVE=$(node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs milestone complete "v[X.Y]" --name "[Milestone Name]")
```
...
```bash
INIT=$(node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs init execute-phase "1")
```
...
```bash
node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs commit "chore: complete v[X.Y] milestone" --files .planning/milestones/v[X.Y]-ROADMAP.md .planning/milestones/v[X.Y]-REQUIREMENTS.md .planning/milestones/v[X.Y]-MILESTONE-AUDIT.md .planning/MILESTONES.md .planning/PROJECT.md .planning/STATE.md
```
```
