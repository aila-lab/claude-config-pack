  ...
  try {
    ...
    if (isEmergency) {
      message = `CONTEXT MONITOR EMERGENCY: Usage at ${usedPct}%. Remaining: ${remaining}%. ` +
        ...
        '1. Output this message to the user: "CONTEXT LIMIT REACHED. Please start a new conversation. Run /gg:resume to continue where we left off." ' +
      ...
      message = `CONTEXT MONITOR CRITICAL: Usage at ${usedPct}%. Remaining: ${remaining}%. ` +
        ...
        '2. If in a Good Guys project, run /gg:pause to save execution state. ' +
        '3. Tell the user: "Context window is nearly full. I recommend starting a new conversation. Use /gg:resume to continue exactly where we left off." ' +
        '4. If no Good Guys project, output a brief handoff summary of current work state.';
    } else {
      message = `CONTEXT MONITOR WARNING: Usage at ${usedPct}%. Remaining: ${remaining}%. ` +
        ...
        '4. If using Good Guys, prepare for /gg:pause if needed.';
    }
