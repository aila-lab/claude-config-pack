...
```bash
INIT=$(node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs init progress)
```
...
- `STATE=$(node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs progress bar --raw)
```
