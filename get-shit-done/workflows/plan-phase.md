...
@C:/Users/ymeli/.claude/get-shit-done/references/ui-brand.md
</required_reading>
...
```bash
INIT=$(node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs init plan-phase "$PHASE")
```
...
```bash
PHASE_INFO=$(node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs roadmap get-phase "${PHASE}")
```
...
```bash
PHASE_DESC=$(node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs roadmap get-phase "${PHASE}" | jq -r '.section')
PHASE_REQ_IDS=$(node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs roadmap get-phase "${PHASE}" | jq -r '.section // empty' | grep -i "Requirements:" | head -1 | sed 's/.*Requirements:\*\*\s*//' | sed 's/[\[\]]//g' | tr ',' '\n' | sed 's/^ *//;s/ *$//' | grep -v '^$' | tr '\n' ',' | sed 's/,$//')
```
...
```
Task(
  prompt="First, read C:/Users/ymeli/.claude/agents/gsd-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
**If found:**
1. Read validation template from `C:/Users/ymeli/.claude/get-shit-done/templates/VALIDATION.md`
...
```bash
node C:/Users/ymeli/.claude/get-shit-done/bin/gsd-tools.cjs commit-docs "docs(phase-${PHASE}): add validation strategy"
```
...
```
Task(
  prompt="First, read C:/Users/ymeli/.claude/agents/gsd-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
Task(
  prompt="
    ...
    <execution_context>
    @C:/Users/ymeli/.claude/get-shit-done/workflows/execute-phase.md
    @C:/Users/ymeli/.claude/get-shit-done/references/checkpoints.md
    @C:/Users/ymeli/.claude/get-shit-done/references/tdd.md
    @C:/Users/ymeli/.claude/get-shit-done/references/model-profile-resolution.md
    </execution_context>
